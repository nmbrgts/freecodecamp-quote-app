...
var _user$project$StyleSheet$Button = {ctor: 'Button'};
var _user$project$StyleSheet$QuoteText = {ctor: 'QuoteText'};
var _user$project$StyleSheet$QuoteQuote = {ctor: 'QuoteQuote'};
var _user$project$StyleSheet$QuoteBox = {ctor: 'QuoteBox'};
var _user$project$StyleSheet$LoadingScreen = {ctor: 'LoadingScreen'};
...
var _user$project$StyleSheet$stylesheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		...
		_1: {
			...
			_1: {
				...
				_0: A2(
					_mdgriffith$style_elements$Style$style,
					_user$project$StyleSheet$LoadingScreen,
					{
						ctor: '::',
						_0: _mdgriffith$style_elements$Style_Color$text(_elm_lang$core$Color$white),
						_1: {
							ctor: '::',
							_0: _mdgriffith$style_elements$Style_Font$size(100),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: A2(
						_mdgriffith$style_elements$Style$style,
						_user$project$StyleSheet$QuoteBox,
						{
							ctor: '::',
							_0: _mdgriffith$style_elements$Style_Color$text(_elm_lang$core$Color$white),
							_1: {
					...
					_1: {
						...
						_0: A2(
							_mdgriffith$style_elements$Style$style,
							_user$project$StyleSheet$QuoteQuote,
							{
								ctor: '::',
								_0: _mdgriffith$style_elements$Style_Font$size(75),
								_1: {
									ctor: '::',
									_0: _mdgriffith$style_elements$Style_Font$typeface(
										{
											ctor: '::',
											_0: _mdgriffith$style_elements$Style_Font$fantasy,
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										...
										_1: {
											ctor: '::',
											_0: _mdgriffith$style_elements$Style_Font$lineHeight(0.5),
											_1: {ctor: '[]'}
										}
									}
								}
						...
						_1: {
							...
							_0: A2(
								_mdgriffith$style_elements$Style$style,
								_user$project$StyleSheet$QuoteText,
								{
									ctor: '::',
...
var _user$project$Main$tweetLink = function (url) {
	return A2(
...
var _user$project$Main$authorLine = function (_p0) {
	return A3(
...
var _user$project$Main$quoteBox = function (quote) {
	return A3(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _mdgriffith$style_elements$Element$text(quote),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$apply = F2(
	function (decoder, res) {
		return A2(
			_elm_lang$core$Json_Decode$andThen,
			function (a) {
				return A2(_elm_lang$core$Json_Decode$map, a, decoder);
			},
			res);
	});
var _user$project$Main$liftd = _elm_lang$core$Json_Decode$succeed;
var _user$project$Main$url = 'https://talaikis.com/api/quotes/random/';
var _user$project$Main$makeTweetUrl = F2(
	function (quote, auth) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
								...
								_elm_lang$http$Http$encodeUri(
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											quote,
											A2(_elm_lang$core$Basics_ops['++'], '\" ', auth))))))))));
	});
var _user$project$Main$Quote = F2(
	function (a, b) {
		return {quoteText: a, quoteAuth: b};
	});
var _user$project$Main$qouteDecoder = A2(
	...
	A2(
		...
		_user$project$Main$liftd(_user$project$Main$Quote)));
var _user$project$Main$requestQuote = A2(_elm_lang$http$Http$get, _user$project$Main$url, _user$project$Main$qouteDecoder);
var _user$project$Main$Available = function (a) {
	return {ctor: 'Available', _0: a};
};
var _user$project$Main$Loading = {ctor: 'Loading'};
var _user$project$Main$HandleQuote = function (a) {
	return {ctor: 'HandleQuote', _0: a};
};
var _user$project$Main$init = A2(
	...
	{
		ctor: '::',
		_0: A2(_elm_lang$http$Http$send, _user$project$Main$HandleQuote, _user$project$Main$requestQuote),
		_1: {ctor: '[]'}
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p1 = msg;
		if (_p1.ctor === 'RequestQuote') {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				{
			...
			if (_p1._0.ctor === 'Ok') {
				var _p3 = _p1._0._0.quoteText;
				var _p2 = _p1._0._0.quoteAuth;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_user$project$Main$Available(
						{
							quoteText: _p3,
							quoteAuth: _p2,
							tweetUrl: A2(_user$project$Main$makeTweetUrl, _p3, _p2)
						}),
					{ctor: '[]'});
			} else {
				return A2(
...
var _user$project$Main$RequestQuote = {ctor: 'RequestQuote'};
var _user$project$Main$nextQuoteButton = A3(
	_mdgriffith$style_elements$Element$button,
	_user$project$StyleSheet$Button,
	{
		ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _mdgriffith$style_elements$Element_Events$onClick(_user$project$Main$RequestQuote),
						_1: {ctor: '[]'}
					}
				}
			}
	...
	var content = function () {
		...
		if (_p4.ctor === 'Loading') {
			...
			return A3(
				...
				{
					ctor: '::',
					_0: _user$project$Main$quoteBox(_p5.quoteText),
					_1: {
						ctor: '::',
						_0: _user$project$Main$authorLine(_p5.quoteAuth),
						_1: {
							ctor: '::',
							_0: A3(
								...
								{
									ctor: '::',
									_0: _user$project$Main$tweetLink(_p5.tweetUrl),
									_1: {
										ctor: '::',
										_0: _user$project$Main$nextQuoteButton,
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
